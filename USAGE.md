...
Without ultracode, the skills run their standard direct dispatch. The model invariants hold either way: never Haiku, never Sonnet below `xhigh`, never a Sonnet-authored verdict.
